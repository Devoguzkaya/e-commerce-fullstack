            ...
            <div className="w-[85%]">
                <div className="flex flex-col lg:flex-row mb-12">
                    ...
                    <div className="w-full lg:w-1/2 flex flex-col justify-center bg-[#FAFAFA] p-10 lg:p-20 order-1 lg:order-2">
                        <h3 className="font-bold text-[24px] lg:text-[40px] leading-[32px] lg:leading-[50px] tracking-[0.1px] text-[#252B42] mb-[30px]">
                            {header}
                        </h3>
                        <p className="font-normal text-[14px] leading-[20px] tracking-[0.2px] text-[#737373] mb-[30px] max-w-[350px]">
                            {description}
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-[30px] w-full">
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <div className="text-[#737373] text-[14px] font-bold">
                                    {product.sales}
                                </div>
                                <div className="flex gap-[5px] font-bold text-[16px] leading-[24px] tracking-[0.1px]">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    {features.map((feature, index) => (
                        <div key={index} className="flex flex-col gap-4">
                            <h3 className="font-bold text-[40px] leading-[57px] tracking-[0.2px] text-[#E74040]">
                                {index + 1}.
                            </h3>
                            <h5 className="font-bold text-[16px] leading-[24px] tracking-[0.1px] text-[#252B42]">
                                {feature}
